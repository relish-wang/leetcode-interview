...
| [0695][0695]     | 岛屿的最大面积               | 中等 |                    10:59                     | dfs秒了                                                                                                              |
| [0712][0712]     | 两个字符串的最小ASCII删除和      | 中等 |                    15:30                     | ⚠️经典二维数组动态规划。@see [0072][0072]、[1143][1143]  建议三道一起刷                                                               |
| [0889][0889]     | 根据前序和后序遍历构造二叉树        | 中等 |                    28:42                     | ⚠️ 慢了, 现场不能调试会更难, 要练                                                                                               |
| [1028][1028]     | 从先序遍历还原二叉树            | 困难 |                    15:49                     | 正则(group+find)+stack 秒了。注意在合适的时机出栈                                                                                 |
| [1115][1115]     | 交替打印 FooBar           | 中等 | 08:02<br>07:51<br> ⚠️21:03<br>05:00<br>04:33 | BlockingQueue<br>synchronized+flag+wait+notifyAll<br>ReentrantLock+Condition<br>Thread.yield()<br>CyclicBarrier(2) |
